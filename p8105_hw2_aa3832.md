...
There are 43 stations that have entrances but do not have vending.
...
#### Cleaning up route name and route number
...
```
    ...
    ## # A tibble: 981 x 4
    ##    line     station_name route_number route_name
    ##    <chr>    <chr>        <chr>        <chr>     
    ##  1 4 Avenue 25th St      1            R         
    ##  2 4 Avenue 36th St      1            N         
    ##  3 4 Avenue 36th St      2            R         
    ##  4 4 Avenue 45th St      1            R         
    ##  5 4 Avenue 53rd St      1            R         
    ##  6 4 Avenue 59th St      1            N         
    ##  7 4 Avenue 59th St      2            R         
    ##  8 4 Avenue 77th St      1            R         
    ##  9 4 Avenue 86th St      1            R         
    ## 10 4 Avenue 95th St      1            R         
    ## # … with 971 more rows
